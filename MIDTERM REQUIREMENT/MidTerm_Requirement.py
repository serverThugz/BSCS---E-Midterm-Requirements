...
def loading():
    ...
    loading = Tk()  # Define 'loading' as the Tk instance
    loading.geometry("455x560")
    loading.title("Loading")
    img = PhotoImage(file="Me Icon.png")
    loading.iconphoto(False,img)

    # Create a frame with black background
    frame = Frame(loading, bg="black")
    frame.place(x=0, y=0, relwidth=1, relheight=1)

    gifImage = "LoadingGIF.gif"
...
def curriculum_vitae():
    ...
    img = PhotoImage(file="Me Icon.png")
    curriculum_vitae.iconphoto(False,img)
    ...
    cv_picture = ImageTk.PhotoImage(file="CV_Image.jpg")
    ...
    personalInfo_lbl = Label(Tp_wht_mainBox, text="Personal Information", font=("Poppins", 10, "bold"), fg="black",
                             bg="white")
    ...
    con_religion_lbl = Label(Tp_wht_mainBox, text="Religion: Roman Catholic", font=("Poppins", 10), fg="black",
                             bg="white")
    ...
    educBckgrd_lbl = Label(left_frm, text="Educational Background", font=("Poppins", 10, "bold"), fg="black",
                           bg="white")
    ...
    # This is for address
    address_lbl = Label(right_frm, text="Address: Poblacion,Lingig ", font=("Poppins", 9, "bold"), fg="white",
                        bg="gray")
    ...
    research_lbl = Label(right_frm, text="Research Competition Finalist ", font=("Poppins", 7, "bold"), fg="white",
                         bg="gray")
    research_lbl.place(x=20, y=190)
    con_research_lbl = Label(right_frm, text="Municipal SHS Expo cum ", font=("Poppins", 7, "bold"), fg="white",
                             bg="gray")
    ...
    research2_lbl = Label(right_frm, text="2nd Place Research Booth ", font=("Poppins", 7, "bold"), fg="white",
                          bg="gray")
    research2_lbl.place(x=20, y=270)
    con3_research_lbl = Label(right_frm, text="Municipal SHS Expo cum ", font=("Poppins", 7, "bold"), fg="white",
                              bg="gray")
